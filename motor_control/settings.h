...
//#define whichSensor false //This change which sensor input is being used. True = Digital; False = analogue.
...
#define useVoltageControl false //This will limit the battery output voltage to an average of the set voltage 'VCMax'. If the average battery voltage is less than that it will output max else it will PWM to set the average around this.
...
#define channel 115200 //This is the channel which the arduino serial bus communicates at.
